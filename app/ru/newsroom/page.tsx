...
export const metadata: Metadata = {
  title: 'Пресс-центр | SINOMINING',
  description: 'Следите за последними новинками, партнёрскими проектами и новостями компании.',
}

export default function NewsroomRu() {
  const { breadcrumb, newsroom, releases } = getContent('ru')

  return (
    <div className="flex min-h-screen flex-col">
      <SiteHeader lang="ru" altHref="/ru/newsroom" />
