...
export const metadata: Metadata = {
  title: 'Newsroom | SINOMINING',
  description: 'Stay updated with the latest product launches, project collaborations, and company news from SINOMINING.',
}
