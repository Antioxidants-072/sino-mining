...
export const metadata: Metadata = {
  title: 'Newsroom | AnHui Sinomining Machinery',
  description:
    'Stay up to date with the latest product launches, project partnerships and company news from AnHui Sinomining Machinery.',
}

export default function EnglishNewsroomPage() {
  const { breadcrumb, newsroom, releases } = getContent('en')
