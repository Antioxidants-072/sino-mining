  ...
  const steps: EpcStep[] = [
    {
      ...
      summary: '依托专业科研试验室，提供从矿石试验到选矿厂整体工程的精准定制设计。',
      features: [
        { title: '选矿试验与方案制定', description: '结合矿石性质，科学选定工艺路线，最大化矿石选别指标与经济效益。' },
        { title: '数字化设计', description: '采用 CAD、SolidWorks 及 ANSYS 有限元分析系统，完成高宽容度的工艺流程与总平面数字化设计。' },
        { title: '仿真模拟与精准设备选型', description: '三维仿真，结合 70+ 项授权专利技术，匹配最佳处理能力与低能耗的设备配置。' },
      ],
    ...
    },
    {
      ...
      summary: '中能矿机具备强大设备自主制造能力。依托 120,000 m² 现代制造基地与 160+ 台套高精加工设备，专注核心选矿装备的自主研发与高质量生产。',
      features: [
        { title: '自有工厂高精制造', description: '拥有数控车床、激光切割机、自动埋弧焊及铸造厂、橡胶新材料厂，实现浮选机、搅拌槽、浓缩设备等核心装备的 100% 自主可控生产。' },
    ...
    },
    {
      ...
      summary: '遣经验丰富的专业工程团队驻扎项目现场，高效完成设备安装、单机调试及全线联动试车。',
      features: [
        { title: '专业团队驻场指导', description: '指导安装调试/安装，凭借 20 余年现场施工与 400+ 个全球项目落地经验，确保复杂地形下的安全规范施工。' },
        { title: '精密安装与单机调试', description: '对机械结构、传动系统及自动化控制节点进行严格校准与单机运行测试。' },
