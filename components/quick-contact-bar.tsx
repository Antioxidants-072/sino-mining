...
export function QuickContactBar({ lang }: { lang: Lang }) {
  ...
  return (
    <section className="border-t border-border bg-muted/40" aria-label={isChinese ? '快速联系方式' : 'Quick contact'}>
      <div className="mx-auto flex max-w-[1600px] flex-wrap items-center justify-center gap-x-10 gap-y-5 px-6 py-6 font-sans text-base text-muted-foreground sm:gap-x-14 sm:py-7 lg:px-10">
